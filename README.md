...
一个基于 FastAPI 和 TypeScript 的智能理财助手系统，集成基金估值、黄金预测、市场数据监控等功能，通过 MCP 和 Skill 与 AI 助手深度集成，提供全方位的理财决策支持。

## 功能特性

- **基金估值**：盘中实时计算基金估算净值和涨跌幅，支持多策略估值引擎
- **黄金预测**：基于机器学习（LightGBM/XGBoost/Ridge）的黄金价格预测与回测
...
4. **黄金预测**：基于历史数据和宏观因子，仅供参考，不构成投资建议
